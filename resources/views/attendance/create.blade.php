                    ...
                    <form method="POST" action="{{ route('attendance.store') }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input name="date" type="date" id="date" class="form-control @error('date') is-invalid @enderror" value="{{ old('date', \Carbon\Carbon::today()->toDateString()) }}">
                                @error('date') <span class="invalid-feedback">{{ $message }}</span> @enderror
                            </div>
                            <div class="col-md-6">
                                <label for="check_in" class="form-label">Check In</label>
                                <input name="check_in" type="time" id="check_in" class="form-control @error('check_in') is-invalid @enderror" value="{{ old('check_in', \Carbon\Carbon::now()->format('H:i')) }}">
